...
--
-- Структура таблицы `wt_2012`
--

DROP TABLE IF EXISTS `wt_2012`;
CREATE TABLE IF NOT EXISTS `wt_2012` (
  `wt_2012_id` int(11) NOT NULL auto_increment,
